...
export const worksheetProducts: Product[] = [
  ...
  { id: 15, title: "Numbers Tracing 1–20 Workbook",        salePrice: "$4", originalPrice: "$6",  seller: "Tiny Sprout Studio",  image: "/images/numbers tracing.png",                         rating: 4.7, reviewCount: 64,  onSale: true,  instantDownload: true  },
  { id: 16, title: "Shapes & Patterns Worksheet Pack",     salePrice: "$5", originalPrice: "$8",  seller: "Paper Moon Studio",   image: "/images/Shapes and Patterns Worksheet Pack.png",      rating: 4.8, reviewCount: 119, onSale: false, instantDownload: true  },
  { id: 17, title: "Cursive Handwriting Practice Pack",    salePrice: "$6", originalPrice: "$9",  seller: "Acorn Learning Lab",  image: "/images/Cursive Handwriting Practice Pack.png",       rating: 4.8, reviewCount: 47,  onSale: true,  instantDownload: true  },
];
...
export const activityProducts: Product[] = [
  ...
  { id: 26, title: "Emotions & Feelings Activity Kit",     salePrice: "$5", originalPrice: "$8",  seller: "Bright Beans Studio", image: "/images/Emotions and Feelings Activity Kit.png",      rating: 4.7, reviewCount: 89,  onSale: true,  instantDownload: true  },
  { id: 27, title: "Solar System Exploration Pack",        salePrice: "$7", originalPrice: "$11", seller: "Wild Oak Learning",   image: "/images/solar system exploration for kids.png",       rating: 4.9, reviewCount: 152, onSale: false, instantDownload: true  },
  { id: 28, title: "Build-a-Bug Science Activity Set",     salePrice: "$6", originalPrice: "$9",  seller: "Acorn Learning Lab",  image: "/images/Build-a-Bug Science Activity.png",            rating: 4.6, reviewCount: 41,  onSale: true,  instantDownload: true  },
];
...
export const partyKitProducts: Product[] = [
  ...
  { id: 32, title: "Mermaid Party Printable Bundle",       salePrice: "$9", originalPrice: "$14", seller: "Honey Bee Prints",    image: "/images/Mermaid Party Printable Bundle.png",          rating: 4.9, reviewCount: 267, onSale: true,  instantDownload: true  },
  { id: 33, title: "Safari Birthday Party Pack",           salePrice: "$8", originalPrice: "$12", seller: "Sweet Pea Press",     image: "/images/Safari Birthday Party Pack.png",              rating: 4.7, reviewCount: 94,  onSale: false, instantDownload: true  },
...
export const identificationProducts: Product[] = [
  ...
  { id: 43, title: "Alphabet Chart 2",                    salePrice: "$5", originalPrice: "$8",  seller: "Meadow Lane Prints", image: "/images/Alphabet2.png",            rating: 5.0, reviewCount: 0, onSale: false, instantDownload: true },
];
