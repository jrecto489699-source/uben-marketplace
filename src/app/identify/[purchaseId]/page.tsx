...
const LAYOUT_42: Spot[] = [
  ...
  { name: "a", label: "A", x: 16, y: 4 },
  { name: "b", label: "B", x: 32, y: 4 },
  { name: "c", label: "C", x: 48, y: 4 },
  { name: "d", label: "D", x: 64, y: 4 },
  { name: "e", label: "E", x: 80, y: 4 },
  { name: "f", label: "F", x: 96, y: 4 },
  // Row 2 — Grapes, House, Ice cream, Jellyfish, Kite, Lemon
  { name: "g", label: "G", x: 16, y: 23 },
  { name: "h", label: "H", x: 32, y: 23 },
  { name: "i", label: "I", x: 48, y: 23 },
  { name: "j", label: "J", x: 64, y: 23 },
  { name: "k", label: "K", x: 80, y: 23 },
  { name: "l", label: "L", x: 96, y: 23 },
  // Row 3 — Mouse, Nose, Orange, Pig, Queen, Rabbit
  { name: "m", label: "M", x: 16, y: 45 },
  { name: "n", label: "N", x: 32, y: 45 },
  { name: "o", label: "O", x: 48, y: 45 },
  { name: "p", label: "P", x: 64, y: 45 },
  { name: "q", label: "Q", x: 80, y: 45 },
  { name: "r", label: "R", x: 96, y: 45 },
  // Row 4 — Sun, Tomato, Umbrella, Violin, Wizard, Xylophone
  { name: "s", label: "S", x: 16, y: 66 },
  { name: "t", label: "T", x: 32, y: 66 },
  { name: "u", label: "U", x: 48, y: 66 },
  { name: "v", label: "V", x: 64, y: 66 },
  { name: "w", label: "W", x: 80, y: 66 },
  { name: "x", label: "X", x: 96, y: 66 },
  // Row 5 — Yo-yo, Zebra
  { name: "y", label: "Y", x: 16, y: 86 },
  { name: "z", label: "Z", x: 32, y: 86 },
];
