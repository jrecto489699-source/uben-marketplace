...
const LAYOUT_42: Spot[] = [
  ...
  { name: "b", label: "B", x: 31, y: 3 },
  { name: "c", label: "C", x: 47, y: 3 },
  { name: "d", label: "D", x: 63, y: 3 },
  { name: "e", label: "E", x: 78, y: 3 },
  { name: "f", label: "F", x: 94, y: 3 },
  // Row 2 — Grapes, House, Ice cream, Jellyfish, Kite, Lemon
  { name: "g", label: "G", x: 16, y: 20 },
  { name: "h", label: "H", x: 31, y: 20 },
  { name: "i", label: "I", x: 47, y: 20 },
  { name: "j", label: "J", x: 63, y: 20 },
  { name: "k", label: "K", x: 78, y: 20 },
  { name: "l", label: "L", x: 94, y: 20 },
  // Row 3 — Mouse, Nose, Orange, Pig, Queen, Rabbit
  { name: "m", label: "M", x: 16, y: 36 },
  { name: "n", label: "N", x: 31, y: 36 },
  { name: "o", label: "O", x: 47, y: 36 },
  { name: "p", label: "P", x: 63, y: 36 },
  { name: "q", label: "Q", x: 78, y: 36 },
  { name: "r", label: "R", x: 94, y: 36 },
  // Row 4 — Sun, Tomato, Umbrella, Violin, Wizard, Xylophone
  { name: "s", label: "S", x: 16, y: 52 },
  { name: "t", label: "T", x: 31, y: 52 },
  { name: "u", label: "U", x: 47, y: 52 },
  { name: "v", label: "V", x: 63, y: 52 },
  { name: "w", label: "W", x: 78, y: 52 },
  { name: "x", label: "X", x: 94, y: 52 },
  // Row 5 — Yo-yo, Zebra
  { name: "y", label: "Y", x: 16, y: 68 },
  { name: "z", label: "Z", x: 31, y: 68 },
];
