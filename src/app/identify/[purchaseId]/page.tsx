...
const LAYOUT_42: Spot[] = [
  ...
  { name: "a", label: "A", x: 16.5, y: 5 },
  { name: "b", label: "B", x: 31.5, y: 5 },
  { name: "c", label: "C", x: 47,   y: 5 },
  { name: "d", label: "D", x: 62.5, y: 5 },
  { name: "e", label: "E", x: 78,   y: 5 },
  { name: "f", label: "F", x: 94.5, y: 5 },
  // Row 2 — Grapes, House, Ice cream, Jellyfish, Kite, Lemon
  { name: "g", label: "G", x: 16.5, y: 22 },
  { name: "h", label: "H", x: 31.5, y: 22 },
  { name: "i", label: "I", x: 47,   y: 22 },
  { name: "j", label: "J", x: 62.5, y: 22 },
  { name: "k", label: "K", x: 78,   y: 22 },
  { name: "l", label: "L", x: 94.5, y: 22 },
  // Row 3 — Mouse, Nose, Orange, Pig, Queen, Rabbit
  { name: "m", label: "M", x: 16.5, y: 38 },
  { name: "n", label: "N", x: 31.5, y: 38 },
  { name: "o", label: "O", x: 47,   y: 38 },
  { name: "p", label: "P", x: 62.5, y: 38 },
  { name: "q", label: "Q", x: 78,   y: 38 },
  { name: "r", label: "R", x: 94.5, y: 38 },
  // Row 4 — Sun, Tomato, Umbrella, Violin, Wizard, Xylophone
  { name: "s", label: "S", x: 16.5, y: 55 },
  { name: "t", label: "T", x: 31.5, y: 55 },
  { name: "u", label: "U", x: 47,   y: 55 },
  { name: "v", label: "V", x: 62.5, y: 55 },
  { name: "w", label: "W", x: 78,   y: 55 },
  { name: "x", label: "X", x: 94.5, y: 55 },
  // Row 5 — Yo-yo, Zebra
  { name: "y", label: "Y", x: 16.5, y: 72 },
  { name: "z", label: "Z", x: 31.5, y: 72 },
];
